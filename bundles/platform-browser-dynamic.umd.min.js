...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var R=[o.ɵINTERNAL_BROWSER_PLATFORM_PROVIDERS,{provide:r.COMPILER_OPTIONS,useValue:{providers:[{provide:t.ResourceLoader,useClass:I,deps:[]}]},multi:!0},{provide:r.PLATFORM_ID,useValue:n.ɵPLATFORM_BROWSER_ID}],C=function(e){function t(){var t=e.call(this)||this;if(t._cache=r.ɵglobal.$templateCache,null==t._cache)throw new Error("CachedResourceLoader: Template cache was not found in $templateCache.");return t}return a(t,e),t.prototype.get=function(e){return this._cache.hasOwnProperty(e)?Promise.resolve(this._cache[e]):Promise.reject("CachedResourceLoader: Did not find cached template for "+e)},t}(t.ResourceLoader),v=new r.Version("12.0.0-next.8+60.sha-60d0234"),_=[{provide:t.ResourceLoader,useClass:C,deps:[]}],M=r.createPlatformFactory(h,"browserDynamic",R);
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *

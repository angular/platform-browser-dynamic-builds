 ...
 */
var p=function(e){function t(r){var t=e.call(this)||this;return t._doc=r,t}return function o(e,r){function t(){this.constructor=e}s(e,r),e.prototype=null===r?Object.create(r):(t.prototype=r.prototype,new t)}(t,e),t.prototype.insertRootElement=function(e){for(var r=i.ɵgetDOM().firstChild(i.ɵgetDOM().content(i.ɵgetDOM().createTemplate('<div id="'+e+'"></div>'))),t=i.ɵgetDOM().querySelectorAll(this._doc,"[id^=root]"),o=0;o<t.length;o++)i.ɵgetDOM().remove(t[o]);i.ɵgetDOM().appendChild(this._doc.body,r)},l([r.Injectable(),function n(e,r){return function(t,o){r(t,o,e)}}(0,r.Inject(i.DOCUMENT)),function c(e,r){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,r)}("design:paramtypes",[Object])],t)}(t.TestComponentRenderer),u=0,f=function(){function e(){this._references=new Map}return e.prototype.overrideMetadata=function(e,t,o){var n={};if(t&&function i(e){var r=[];Object.keys(e).forEach(function(e){e.startsWith("_")||r.push(e)});for(var t=e;t=Object.getPrototypeOf(t);)Object.keys(t).forEach(function(e){var o=Object.getOwnPropertyDescriptor(t,e);!e.startsWith("_")&&o&&"get"in o&&r.push(e)});return r}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
e.platformBrowserDynamicTesting=y,e.BrowserDynamicTestingModule=_,e.ɵDOMTestComponentRenderer=p,e.ɵplatformCoreDynamicTesting=h,Object.defineProperty(e,"__esModule",{value:!0})});
...
/*! *****************************************************************************
    ...
    ***************************************************************************** */var s=function(e,r){return(s=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,r){e.__proto__=r}||function(e,r){for(var o in r)r.hasOwnProperty(o)&&(e[o]=r[o])})(e,r)},p=function(e){function r(r){var o=e.call(this)||this;return o._doc=r,o}return function o(e,r){function o(){this.constructor=e}s(e,r),e.prototype=null===r?Object.create(r):(o.prototype=r.prototype,new o)}(r,e),r.prototype.insertRootElement=function(e){var r=n.ɵgetDOM().getDefaultDocument().createElement("template");r.innerHTML='<div id="'+e+'"></div>';for(var o=function t(e){return"content"in e?e.content:e}
/**
     * @license
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.BrowserDynamicTestingModule=a,e.platformBrowserDynamicTesting=f,e.ɵDOMTestComponentRenderer=p,e.ɵplatformCoreDynamicTesting=v,Object.defineProperty(e,"__esModule",{value:!0})}));
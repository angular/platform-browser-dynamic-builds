...
/*! *****************************************************************************
    ...
    ***************************************************************************** */var s=function(e,r){return(s=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,r){e.__proto__=r}||function(e,r){for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&(e[o]=r[o])})(e,r)},p=function(e){function r(r){var o=e.call(this)||this;return o._doc=r,o}return function o(e,r){if("function"!=typeof r&&null!==r)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");function o(){this.constructor=e}s(e,r),e.prototype=null===r?Object.create(r):(o.prototype=r.prototype,new o)}(r,e),r.prototype.insertRootElement=function(e){var r=n.ɵgetDOM().getDefaultDocument().createElement("div");r.setAttribute("id",e);for(var o=this._doc.querySelectorAll("[id^=root]"),t=0;t<o.length;t++)n.ɵgetDOM().remove(o[t]);this._doc.body.appendChild(r)},r}(o.TestComponentRenderer);p.ɵfac=function e(o){return new(o||p)(r.ɵɵinject(n.DOCUMENT))},p.ɵprov=r.ɵɵdefineInjectable({token:p,factory:p.ɵfac});
/**
     * @license

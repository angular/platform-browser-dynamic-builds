...
exports.BROWSER_APP_COMPILER_PROVIDERS = [
    ...
    { provide: compiler_1.ResourceLoader, useClass: xhr_impl_1.TemplateLoaderImpl },
 ...
 * @experimental
 */
exports.RESOURCE_CACHE_PROVIDER = [{ provide: compiler_1.ResourceLoader, useClass: xhr_cache_1.CachedResourceLoader }];
 ...
 * @experimental
 */
exports.BROWSER_DYNAMIC_COMPILER_FACTORY = compiler_1.RUNTIME_COMPILER_FACTORY.withDefaults({ providers: [{ provide: compiler_1.ResourceLoader, useClass: xhr_impl_1.TemplateLoaderImpl }] });
/**

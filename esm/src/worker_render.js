...
import { WORKER_RENDER_APPLICATION_PROVIDERS, WORKER_RENDER_STARTABLE_MESSAGING_SERVICE } from '@angular/platform-browser';
...
export const WORKER_RENDER_DYNAMIC_APPLICATION_PROVIDERS = [
